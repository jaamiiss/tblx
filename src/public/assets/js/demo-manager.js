      ...
      if (isChartContainer) {
        ...
        if (!existingLoader) {
          ...
          loadingDiv.innerHTML = `
            ...
            <div class="demo-loading-text">${window.StringSchema && window.StringSchema.getLoadingMessage ? window.StringSchema.getLoadingMessage('demo') : 'Loading...'}</div>
          `;
...
function initDemoManager() {
  ...
  if (window.location.pathname.startsWith('/admin')) {
    console.log('Demo Manager: Skipping initialization on admin page');
    return;
  }
